    ...
    <div class="event-brick-grid">
      ...
      ?>
          ...
          <div class="buttons-brick-cell">
            <a class="btn btn-primary mt-1 mb-1" href='<?php echo $url; ?>?changePlayerState=<?php echo $row->getId(); ?>'><?php if ($row->getIsPlayer() == 0) { ?>Promouvoir joueur<?php } else { ?>&nbsp;<i class="fa-solid fa-circle-minus"></i>&nbsp;Destituer Joueur<?php } ?></a>
